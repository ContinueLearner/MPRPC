...
// repeated .fixbug.User userList = 2;
inline int GetFriendListResponse::_internal_userlist_size() const {
  return userlist_.size();
}
inline int GetFriendListResponse::userlist_size() const {
  return _internal_userlist_size();
}
inline void GetFriendListResponse::clear_userlist() {
  userlist_.Clear();
}
inline ::fixbug::User* GetFriendListResponse::mutable_userlist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.userList)
  return userlist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListResponse::mutable_userlist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.userList)
  return &userlist_;
}
inline const ::fixbug::User& GetFriendListResponse::_internal_userlist(int index) const {
  return userlist_.Get(index);
}
inline const ::fixbug::User& GetFriendListResponse::userlist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.userList)
  return _internal_userlist(index);
}
inline ::fixbug::User* GetFriendListResponse::_internal_add_userlist() {
  return userlist_.Add();
}
inline ::fixbug::User* GetFriendListResponse::add_userlist() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.userList)
  return _internal_add_userlist();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponse::userlist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.userList)
  return userlist_;
}
